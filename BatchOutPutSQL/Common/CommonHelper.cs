...
namespace Test2.Common
{
    ...
    public class CommonHelper
    {
        ...
        /// <summary>
        /// 获得当前时间的string.Emptyyyyy-MM-dd HH:mm:ss:fffffffstring.Empty格式字符串
        /// </summary>
        ...
        /// <summary>
        /// 获得当前时间的string.Emptyyyyy年MM月dd日 HH:mm:ssstring.Empty格式字符串
        /// </summary>
        ...
        /// <summary>
        /// 获得当前时间的string.Emptyyyyy-MM-dd HH:mm:ssstring.Empty格式字符串
        /// </summary>
        ...
        {
            return RemoveArrayItem(array, string.Empty, true, false);
        }
        ...
        {
            return RemoveArrayItem(StringHelper.SplitString(s, splitStr), string.Empty, true, false);
        }
        ...
        {
            return RemoveArrayItem(StringHelper.SplitString(s), string.Empty, true, false);
        }
        ...
        {
            if (!string.IsNullOrEmpty(str))
                return _tbbrRegex.Replace(str, string.Empty);
        ...
        /// 将2个byte[] 合并成一个
        /// </summary>
        /// <param name="bt1">第一个byte[]</param>
        /// <param name="bt2">第二个byte[]</param>
        /// <returns></returns>
        public static byte[] TwoByteMergin(byte[] bt1, byte[] bt2)
        {
            byte[] resByte = new byte[bt1.Length + bt2.Length];
            bt1.CopyTo(resByte, 0);
            bt2.CopyTo(resByte, bt1.Length);
            return resByte;
        }
